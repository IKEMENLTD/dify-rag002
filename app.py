...
def security_headers(response):
    ...
    # CSP temporarily disabled to allow inline styles and scripts
    # response.headers['Content-Security-Policy'] = "default-src 'self'; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline'; font-src 'self' data:; img-src 'self' data: blob:;"
    return response
